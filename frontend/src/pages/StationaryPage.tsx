    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Manage your stationery listings
          </p>
        </div>
      ...
      <div className="grid md:grid-cols-[220px_1fr] gap-4 mb-8">
        ...
        <div className="bg-white border rounded-xl p-4 shadow-sm">
          <input
            type="text"
            placeholder="Search your stationery..."
            value={search}
            onChange={(e) =>
      ...
      {stationary.length === 0 ? (
        <div className="bg-white border rounded-2xl py-20 text-center">
          ...
          <p className="text-gray-500 mt-2">
            List your stationery products to start selling.
          </p>
            ...
            >
              ...
              <div className="relative">
                <img
                  src={
                    item.imageUrl ||
                    "https://placehold.co/600x400?text=Stationery"
                  }
                  alt={item.title}
